...
5. `02-cong-nghe-su-dung.md` - công nghệ, lệnh chạy, Docker và cấu hình môi trường.

## Danh sách tài liệu

| File | Nội dung |
|---|---|
| `00-ai-context-homi.md` | Ngữ cảnh cô đọng cho AI: công nghệ, tuyến trang, API, database, auth, quy tắc phát triển |
| `01-tong-quan-du-an.md` | Tổng quan sản phẩm, tác nhân, module và kiến trúc |
...
| `06-use-case.md` | Trường hợp sử dụng chính theo tác nhân |
