...
export function Badge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-full border border-white/35 px-3 py-1 text-xs font-semibold tracking-wide shadow-sm backdrop-blur-md transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[var(--shadow-card)]",
        badgeStyles[tone],
        className,
      )}
    >
