...
INSERT INTO room_reports (
    ...
    (
        ...
        2,
        'UNAVAILABLE',
        'Nguoi dang tin bao phong da het nhung bai dang van hien thi con phong tren website.',
        'NEW',
        NULL,
        NULL,
        NULL,
    ...
    (
        ...
        3,
        'WRONG_INFO',
        'Gia phong thuc te cao hon gia dang tren bai viet, can admin xac minh lai.',
        'REVIEWING',
        'Da ghi nhan, can lien he chu tro de doi chieu thong tin gia.',
        1,
        '2026-04-18 14:10:00',
        '2026-04-18 13:40:00',
        '2026-04-18 14:10:00'
...
INSERT INTO notifications (
    ...
    (
        ...
        'NEW_CONTACT_REQUEST',
        'Yeu cau lien he moi',
        'Nguyen Thi An da gui yeu cau xem phong Studio gan Dai hoc Quoc gia Ha Noi.',
    ...
    (
        ...
        'NEW_CONTACT_REQUEST',
        'Yeu cau lien he moi',
        'Tran Quoc Binh can them thong tin ve phi dich vu va hop dong thue khu Bach Khoa.',
        '/admin/contact-requests',
        TRUE,
        '2026-04-13 08:15:00'
    ),
    (
        ...
        'NEW_CONTACT_REQUEST',
        'Yeu cau lien he moi',
        'Tran Quoc Binh quan tam studio gan My Dinh co ban cong.',
        '/admin/contact-requests',
        FALSE,
        '2026-04-16 07:50:00'
    )
